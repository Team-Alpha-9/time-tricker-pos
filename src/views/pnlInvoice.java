...
public class pnlInvoice extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1382, 651));
    ...
    private int saveInvoice() {
        ...
        ResultSet rs = null;
        try {
            pst = conn.prepareStatement("INSERT INTO invoice(customer_id, invoice_date, item_count, total_amount, discount, payed_amount, status, user_id) VALUES(?,?,?,?,?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
            pst.setInt(1, cusId);
            ...
            pst.setString(6, txtPayAmount.getText());
            ...
            pst.setInt(8, LoggingSession.getUserId());
